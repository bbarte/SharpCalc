    ...
    class Program
    {
        ...
        */
        ...
        private static void PrintHelp()
        {
            ...
            Console.WriteLine(@"   ▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒");
            Console.ResetColor();
            Console.WriteLine("I. Inserting data into a cell:");
            Console.WriteLine("    FORMAT: column number-row number:your text");
            Console.WriteLine("    EXAMPLE: '3-2:HOME BUDGET'");
            Console.WriteLine("        This command will put the text 'HOME BUDGET' into the 2nd column and the 3rd row.");
            Console.WriteLine("II. Formulas and commands");
            ...
            Console.WriteLine("III. Some other userful things");
